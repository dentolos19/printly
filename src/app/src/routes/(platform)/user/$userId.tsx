...
import { PostDetailDialog, PostGrid } from "#/routes/(platform)/community/-components";
import { FollowListDialog } from "#/routes/(platform)/user/-components/follow-list-dialog";
import { ManagedUsersCard } from "#/routes/(platform)/user/-components/managed-users-card";
            ...
            <div className="flex flex-1 flex-col justify-between">
              <div>
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {isOwnProfile && (
                      <Button onClick={() => navigate({ to: "/user/settings" })} size="lg" variant="outline">
...
export const Route = createFileRoute("/(platform)/user/$userId")({
