        ...
        <div className="relative z-10 mx-auto max-w-2xl space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 pt-4">
            <Button
              ...
              onClick={() =>
                toast.info("🚧 Demo Preview", {
                  description: "This is a demo website — not an official store. No orders will be fulfilled.",
                })
              }
              size="lg"
            >
          ...
          <div className="border-border mt-12 grid grid-cols-2 gap-8 border-t pt-12 md:grid-cols-4">
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-xs">apps@dennise.me</p>
            </div>
            <div className="space-y-1">
