      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-950 text-white shadow-2xl">
        ...
        <div className="relative flex flex-col items-stretch justify-between gap-12 p-8 md:flex-row md:p-16 lg:p-20">
          <div className="flex-1 space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1 font-medium text-sm backdrop-blur-sm">
              <Users className="size-4" />
              <span>For Teams & Big Events</span>
            </div>

            <h2 className="font-bold text-4xl tracking-tight lg:text-5xl">
          ...
          <div className="max-w-md flex-1">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-md">
              <div className="mb-6 flex items-center gap-3">
                ...
                <h3 className="font-bold text-xl italic">Get an Instant Quote</h3>
              </div>

              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="font-semibold text-slate-500 text-xs uppercase tracking-wider">First Name</label>
                    <Input
                      className="h-12 border-white/10 bg-white/5 text-white placeholder:text-slate-600 focus:ring-primary/50"
                      placeholder="John"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="font-semibold text-slate-500 text-xs uppercase tracking-wider">Last Name</label>
                    <Input
                ...
                <div className="space-y-2">
                  <label className="font-semibold text-slate-500 text-xs uppercase tracking-wider">Work Email</label>
                ...
                <Button className="h-14 w-full font-bold text-lg shadow-primary/20 shadow-xl transition-all hover:scale-[1.02] active:scale-95">
                  Get My Quote
                </Button>
                <p className="pt-2 text-center text-slate-500 text-xs">
