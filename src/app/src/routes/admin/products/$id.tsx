...
import { CommonColors, type ProductSize, ProductSizeLabels } from "#/lib/server/product";

const ModelPreview = lazy(() => import("#/routes/admin/-components/model-preview"));
...
function ProductDetailPage() {
  ...
  }, [api.product, productId, navigate]);
