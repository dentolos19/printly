...
import type { AiSalesAnalysisResponse } from "#/lib/server/analysis";
import type { AdminOrderStatsResponse, MonthlyRevenueData, OrderStatusData } from "#/lib/server/order";
