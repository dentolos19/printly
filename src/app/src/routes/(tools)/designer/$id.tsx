...
import { DesignerCanvas } from "#/routes/(tools)/designer/-components/canvas";
import { DesignerProvider, useKeyboardShortcuts } from "#/routes/(tools)/designer/-components/hooks";
import { IconToolbar } from "#/routes/(tools)/designer/-components/icon-toolbar";
import { LeftPanel, RightPanel } from "#/routes/(tools)/designer/-components/panels";
import { StatusBar } from "#/routes/(tools)/designer/-components/status-bar";
import { ToolbarHeader } from "#/routes/(tools)/designer/-components/toolbar-header";
import type { ArtStyle, GeneratedImage } from "#/routes/(tools)/designer/-types";
...
export const Route = createFileRoute("/(tools)/designer/$id")({
  component: Page,
});
...
function Page() {
  ...
  useEffect(() => {
    ...
    loadData();
  }, [designId, isNew, api.design, api.generate, navigate]);
