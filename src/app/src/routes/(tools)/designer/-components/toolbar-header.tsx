...
export function ToolbarHeader({ className, problemCount = 0 }: ToolbarHeaderProps) {
  ...
  return (
    <div className={cn("flex h-12 items-center border-b bg-background px-2", className)}>
      {/* Back button */}
      <Tooltip>
