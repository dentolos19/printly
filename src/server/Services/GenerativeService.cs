...
public class GenerativeService
{
    ...
    public async Task<string> GenerateTextAsync(string prompt)
    {
        ...
        return responseJson.GetProperty("choices")[0].GetProperty("message").GetProperty("content").GetString() ?? string.Empty;
    }
    ...
    public async Task<Asset> GenerateImageAsync(string prompt)
    {
        ...
        var imageUrl = responseJson.GetProperty("choices")[0].GetProperty("message").GetProperty("images")[0].GetProperty("image_url").GetProperty("url").GetString() ?? string.Empty;
