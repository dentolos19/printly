...
/// <list type="bullet">
/// <item><description>
/// Automatically injects the project's global database context (<see cref="AppDatabase"/>)
/// </description></item>
/// <item><description>
...
[ApiController]
[Route("[controller]")]
public class BaseController(AppDatabase context) : ControllerBase
{
    protected readonly AppDatabase Context = context;
}